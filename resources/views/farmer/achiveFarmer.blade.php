...
<br><br>
<h2 style="padding: 34px 560px"> بيانات المزارعين المؤرشفة</h2>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>هل بالتاكيد تريد حذف بطاقة المزارع نهائيا من النظام ؟</h4>
...
<script>
    $(document).ready(function () {
        ...
        archiveFarmers();
        function archiveFarmers(){
            $.ajax({
                type:"GET",
                url:"{{route('archiveFarmersTable')}}",
                dataType:"json",
                success: function (response) {
                    ...
                    $.each(response.farmers ,function (key ,item) {
                        $('#farmers').append('<tr>\
                                       ...
                                       <td ><button  type="button" value="'+item.id+'" class="btn btn-warning arch_farmer">الغاء الارشفة</button> <button type="button" value="'+item.id+'" class="deletebtn btn btn-danger">حذف نهائي</button></td>\
                                          </tr>');
                    });
                }
            });
