            ...
            <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                ...
                <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-7">
                    <div class="col-xl-7  col-xxl-5">
                            ...
                            <form  class="add_land form" id="kt_form" action=""  method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->pieceNumber}}" class="form-control" name="pieceNumber" id="pieceNumber"  />
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->voucherNumber}}" class="form-control" name="voucherNumber" id="voucherNumber" placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->areaBuildingTenurePurposes}}" oninput="myFunction()" class="form-control"  name="areaBuildingTenurePurposes" id="areaBuildingTenurePurposes" placeholder=""  />
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->areaBuildingNonTenurePurposes}}" oninput="myFunction()" class="form-control"  name="areaBuildingNonTenurePurposes" id="areaBuildingNonTenurePurposes" placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->permanentFallowArea}}" oninput="myFunction()"  class="form-control" name="permanentFallowArea" id="permanentFallowArea" placeholder=""  />
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  value="{{$land->temporaryFallowSpace}}" oninput="myFunction()" class="form-control" name="temporaryFallowSpace" id="temporaryFallowSpace" placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  value="{{$land->cultivatedLandArea}}" oninput="myFunction()" class="form-control" name="cultivatedLandArea" id="cultivatedLandArea" placeholder=""  />
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->areaForestTrees}}" oninput="myFunction()"   class="form-control" name="areaForestTrees" id="areaForestTrees" placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->totalLandArea}}"  readonly class="form-control" name="totalLandArea" id="totalLandArea" placeholder=""  />
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->farFromArmisticeLine}}" name="farFromArmisticeLine" id="farFromArmisticeLine" placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col" >
                                        <!--begin::Input-->
                                        <div class="form-group">
                                            <label >رقم هوية المالك   <span style="color: #ec0c24">*</span> </label>
                                            <input type="text" value="{{$land->idNumber}}" class="form-control" name="idNumber" id="idNumber" placeholder=""  />
                                ...
                                <div class="row" id="single">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->owner}}" class="form-control" name="owner" id="idNumber" placeholder=""  />
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->idNumber2}}" class="form-control" name="idNumber2" id="idNumber2" placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row" id="institution">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->institutionNumber}}" class="form-control" name="institutionNumber" id="institutionNumber"  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->institutionName}}" class="form-control" name="institutionName"  id="institutionName"   />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="col" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->idInstitutionNumber}}"  name="idInstitutionNumber"  id="idInstitutionNumber"  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$land->personInstitutionName}}" class="form-control" name="personInstitutionName" id="personInstitutionName"    />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-3">
                                        ...
                                        <div class="form-group">
                                            <label>الاسم</label>
                                            <input type="text" value="{{$land->fName}}" class="form-control" name="fName" id="fName"  placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->mName}}" name="mName" id="mName"   />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->gName}}" name="gName" id="gName"  placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->lName}}" name="lName" id="lName"   />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                                        ...
                                        <select name="governorate_id" class="form-control SlectBox" >
                                            ...
                                            @isset($governorate)
                                                @foreach($governorate as $item)
                                                    <option {{$land->governorate_id == $item->id ? 'selected' : ''}} value="{{$item->id}}"> {{$item->name}}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->guide}}" name="guide" id="guide" placeholder=""  />
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$land->notes}}" name="notes" id="notes"  placeholder=""  />
                                        </div>
                                        <!--end::Input-->
                                    </div>
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            <div class="card-body">
                                <button onclick="showRowForm1()" class="addPartner btn btn-success  px-6 py-2">اضافة</button>
                                <table class="table  table-checkable" id="kt_datatable1">
                                    ...
                                    <form method="post" class="partners" id="partners">
                                        <input type="hidden" value="{{$land->id}}" name="land_id" id="land_id">
                                        <tr>
                                            <td>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table  table-checkable" id="kt_datatable1">
                                    ...
                                    <form method="post" class="buildings" id="buildings">
                                        <input type="hidden" value="{{$land->id}}" name="land_id" id="farmer_id">
                                        <tr>
                                            <td>
                            ...
                            <div class="card-body">
                                <!--begin: Datatable-->
                                <button onclick="showRowForm3()" class="add_irrigation btn btn-success  px-6 py-2">اضافة </button>
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                                    ...
                                    <tr>
                                        <form id="crops" class="crops" action="" method="post" >
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="cultivatedArea" id="cultivatedArea"    />
                                            </td>
                                            <td>
                                            ...
                                            <td id="q1" style="display: none">
                                                <input type="text" class="form-control" name="causeDepression" id="name"    />
                                            </td>
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                                    ...
                                    <tr>
                                        <form id="vegetables" class="vegetables" action="" method="post" >
                                            ...
                                            <td>
                                                <button class="add_permanentworker btn btn-success  px-6 py-2">حفظ</button>
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                                    ...
                                    <tr>
                                        <form id="trees" class="trees" action="" method="post" >
                                            ...
                                            <td>
                                                <button class=" btn btn-secondry  px-6 py-2">حفظ</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function partners(){
            $.ajax({
                type:"GET",
                url:"{{route('landPartners',$land->id)}}",
                dataType:"json",
        ...
        function building(){
            $.ajax({
                type:"GET",
                url:"{{route('landBuilding',$land->id)}}",
                dataType:"json",
                success: function (response) {
                    //console.log(response.data)
        ...
        function irrigation(){
            $.ajax({
                type:"GET",
                url:"{{route('landIrrigation',$land->id)}}",
                dataType:"json",
                success: function (response) {
                    //console.log(response.data)
        ...
        function vegetables(){
            $.ajax({
                type:"GET",
                url:"{{route('landVegetable',$land->id)}}",
                dataType:"json",
                success: function (response) {
                    //console.log(response.data)
   ...
   console.log(la);
    function initAutocomplete() {
        var map = new google.maps.Map(document.getElementById('map'), {
            center: {lat:{{$land->lat}}, lng:{{$land->lng}}  },
            zoom: 3,
            mapTypeId: 'roadmap'
